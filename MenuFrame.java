...
public class MenuFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Text Hiding under image using LSB");
        ...
        jLabel2.setText("DESIGNED AND DEVELOPED BY \"PAVAN SP\"");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        Encryption a = new Encryption(); // Instantiate encode window
        a.setVisible(true); // Show the window
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        Decryption a = new Decryption(); // Instantiate decode window
        a.setVisible(true);
